        ...
        - _bookshop_name: "layouts/section"
          ...
          content_blocks:
            - _bookshop_name: "elements/heading"
              ...
              level: h3
            - _bookshop_name: "elements/paragraph"
              text: "This grid item has more content and will be taller than the others. It demonstrates how items stretch to fill the row height when using stretch alignment."
            - _bookshop_name: "elements/paragraph"
